    ...
    <div class="container">
        <div id="box" class="box">
            ...
            <ul class="lista-pontos">
                <div class="flex-li">
                    <li>
                        <p>Entrada: </p> <span id="entrada"></span>
                    </li><span onclick="abre_modal('entrada')"> <svg class="pen" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
                ...
                <div class="flex-li">
                    <li>
                        <p>Saida Intervalo: </p> <span id="saida_intervalo"></span>
                    </li><span onclick="abre_modal('saida_intervalo')"> <svg class="pen" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
                            <path d="m7 17.013 4.413-.015 9.632-9.54c.378-.378.586-.88.586-1.414s-.208-1.036-.586-1.414l-1.586-1.586c-.756-.756-2.075-.752-2.825-.003L7 12.583v4.43zM18.045 4.458l1.589 1.583-1.597 1.582-1.586-1.585 1.594-1.58zM9 13.417l6.03-5.973 1.586 1.586-6.029 5.971L9 15.006v-1.589z"></path>
                            <path d="M5 21h14c1.103 0 2-.897 2-2v-8.668l-2 2V19H8.158c-.026 0-.053.01-.079.01-.033 0-.066-.009-.1-.01H5V5h6.847l2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2z"></path>
                        </svg></span>
                </div>
                ...
                <div class="flex-li">
                    <li>
                        <p>Retorno Intervalo: </p> <span id="retorno_intervalo"></span>
                    </li><span onclick="abre_modal('retorno_intervalo')"> <svg class="pen" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
                            <path d="m7 17.013 4.413-.015 9.632-9.54c.378-.378.586-.88.586-1.414s-.208-1.036-.586-1.414l-1.586-1.586c-.756-.756-2.075-.752-2.825-.003L7 12.583v4.43zM18.045 4.458l1.589 1.583-1.597 1.582-1.586-1.585 1.594-1.58zM9 13.417l6.03-5.973 1.586 1.586-6.029 5.971L9 15.006v-1.589z"></path>
                            <path d="M5 21h14c1.103 0 2-.897 2-2v-8.668l-2 2V19H8.158c-.026 0-.053.01-.079.01-.033 0-.066-.009-.1-.01H5V5h6.847l2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2z"></path>
                        </svg> </span>
                </div>
                ...
                <div class="flex-li">
                    <li>
                        <p>Saida: </p> <span id="saida"></span>
                    </li><span onclick="abre_modal('saida')"> <svg class="pen" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
                            <path d="m7 17.013 4.413-.015 9.632-9.54c.378-.378.586-.88.586-1.414s-.208-1.036-.586-1.414l-1.586-1.586c-.756-.756-2.075-.752-2.825-.003L7 12.583v4.43zM18.045 4.458l1.589 1.583-1.597 1.582-1.586-1.585 1.594-1.58zM9 13.417l6.03-5.973 1.586 1.586-6.029 5.971L9 15.006v-1.589z"></path>
                            <path d="M5 21h14c1.103 0 2-.897 2-2v-8.668l-2 2V19H8.158c-.026 0-.053.01-.079.01-.033 0-.066-.009-.1-.01H5V5h6.847l2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2z"></path>
                        </svg></span>
                </div>
                ...
                <li>
                    <p>Horario Limite: </p> <span id="limite"></span>
                </li>
        ...
        function abre_modal(id) {
            ...
            function edita_horario() {
                ...
                if (inputUsuario == "") {
                    ...
                    var time = inputUsuario.split(":");
                    inputToDate = new Date();
                    inputToDate.setHours(time[0]);
                    inputToDate.setMinutes(time[1]);

                    if (id == "entrada") {
                        itemAlterar.innerHTML = inputToDate.toLocaleTimeString('pt-br', {
                            timezone: "America/Sao_Paulo",
                            hour12: true
                        })
                        inputToDate.setHours(inputToDate.getHours() + 10);
                        inputToDate.setMinutes(inputToDate.getMinutes() + 10);
                        limite.innerHTML = inputToDate.toLocaleTimeString('pt-br', {
                            timezone: "America/Sao_Paulo",
                            hour12: true
